...
public class AddDirectedMovieFrame extends JFrame {
	...
	public AddDirectedMovieFrame(VipListFrame vipListFrame, Vip vip) throws SQLException {
		...
		lblAddDirectedMovies.setHorizontalAlignment(SwingConstants.CENTER);
		lblAddDirectedMovies.setBounds(12, 0, 499, 52);
		getContentPane().add(lblAddDirectedMovies);

		JLabel lblSelectedDirector = new JLabel(vip.getSurname()[0] + vip.getName());
		lblSelectedDirector.setHorizontalAlignment(SwingConstants.CENTER);
		lblSelectedDirector.setBounds(12, 53, 499, 52);
		...
		btnAddDirectedMovie.setBounds(407, 114, 104, 25);
